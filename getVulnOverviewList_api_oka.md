...
| pubEndDate            | 発行日開始年月日       | 整数 8 桁                                                                                                                                                 | －   | －         |
| dateFirstPublishedEnd | 発行日終了年月日       | 整数 8 桁                                                                                                                                                 | －   | －         |
...
cpe あるいは、jvnpid の開始バージョンを指定します。
...
cpe あるいは、jvnpid の終了バージョンを指定します。
